...
namespace WebApp.ViewModels
{
    public class ProductViewModel
    {
        ...
        [Range(0, 999999999999999999.9999, ErrorMessage = "Mittesobiv hind! Lubatud hinna vahemik 0-999999999999999999.9999.")]
        ...
        [DisplayName("Toote seisundi liik")] 
        public ProductStateType ProductStateType { get; set; }
