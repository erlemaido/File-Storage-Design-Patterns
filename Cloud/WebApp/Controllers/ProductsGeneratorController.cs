...
namespace WebApp.Controllers
{
    public class ProductsGeneratorController : Controller
    {
        ...
        private static readonly S3StorageService S3StorageService = new();
        ...
        private static void AddRandomProductPictures(IReadOnlyList<IFormFile> allPossiblePics, Product product)
        {
